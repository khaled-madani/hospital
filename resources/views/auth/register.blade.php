...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adminStyle/css/registerStyle.css') }}">
...
<body>
    <main class="sign-up">
        <div class="sign-up__container">
            <div class="sign-up__image">
                <svg class="chart" viewbox="0 0 800 960" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <defs>
                        ...
                        <lineargradient gradientunits="objectBoundingBox" id="e" x1="0.5" x2="0.5" y2="1">
            ...
            <div class="sign-up__content">
                ...
                <form class="sign-up__form form" action="{{ route('register') }}" method="POST">
                    @csrf
                    <div class="form__row">
                        <div class="input">
                            <div class="input__container">
                                <input class="input__field @error('name') is-invalid @enderror" name="name"
                                    value="{{ old('name') }}" id="username" placeholder="Username" type="text"
                                    autocomplete="name" />
                    ...
                    <div class="form__row">
                        <div class="input">
                            ...
                            <div class="input__container">
                                <input class="input__field @error('email') is-invalid @enderror" name="email"
                                    value="{{ old('email') }}" autocomplete="email" id="email" placeholder="Email"
                                    type="text" />
                        ...
                        <div class="input">
                            <div class="input__container">
                                <input id="password" type="password"
                                    class="input__field form-control @error('password') is-invalid @enderror"
                                    name="password" autocomplete="new-password">

                                <label class="input__label" for="password">
                                    Password
                                </label>
                                <i class="eye-btn fa-solid fa-eye"></i>
                    ...
                    <div class="form__row">
                        <div class="input">
                            <div class="input__container">
                                <input id="password-confirm" type="password" class=" input__field form-control"
                                    name="password_confirmation" autocomplete="new-password">
                                <label class="input__label" for="confirm-password">
                                    Confirm password
                                </label>
                                <i class="eye-btn2 fa-solid fa-eye"></i>
    ...
    <script>
        ...
        var pass_conf = document.querySelector('#password-confirm');
        var btn_pass =document.querySelector('.eye-btn');
        var btn_pass_conf =document.querySelector('.eye-btn2');
        ...
        btn_pass_conf.onclick = function() {
            // alert('asdasdasd');
            if (pass_conf.type == 'password') {
                pass_conf.type = 'text';
                btn_pass_conf.classList.add('fa-eye-slash')

            } else {
                pass_conf.type = 'password';
                btn_pass_conf.classList.remove('fa-eye-slash')
